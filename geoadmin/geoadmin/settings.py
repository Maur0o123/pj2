...
CSRF_TRUSTED_ORIGINS = ['https://www.geoadmin.cl','https://geoadmin.cl',"http://localhost","http://127.0.0.1", "https://*.ngrok-free.dev"]
...
MIDDLEWARE = [
    ...
    'administration.middleware.CurrentUserMiddleware',
]
...
if os.name == 'posix':  # Linux y macOS
    preferred_logs_dir = '/home/app/Geoadmin/geoadmin/logs/'
    try:
        os.makedirs(preferred_logs_dir, exist_ok=True)
...
# CONFIGURACION DE ENVÍO REAL (GMAIL)
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'willyslash1@gmail.com'
EMAIL_HOST_PASSWORD = 'advsihzfltymfxjc'
DEFAULT_FROM_EMAIL = 'willyslash1@gmail.com'

# CONFIGURACION ORIGINAL (COMENTADA)
...
if DEBUG:
    ...
    BASE_API_URL = "https://geoadmin.cl"
