...
(function ($) {
    ...
    $(window).on("load", function (e) {
        ...
        var elemento = document.getElementById('id_drawer');
        if (elemento){
            if (document.querySelector('body').classList.contains('dark-mode')) {
                elemento.classList.remove('drawer');
                elemento.classList.add('drawer-dark');
            } else {
                elemento.classList.remove('drawer-dark');
                elemento.classList.add('drawer');
            }
        }
