document.getElementById('div_id_maquinaria').classList.add('col-md-4');
document.getElementById('div_id_descripcion').classList.add('col-md-4');
document.getElementById('div_id_fechaAdquisicion').classList.add('col-md-4');
