function MultiSelectTag(e, t = { shadow: !1, rounded: !0 }) {
    ...
    function f(e = null) {
        ...
        if (t.selected) !w(t.value) && g(t);
            ...
            e && t.label.toLowerCase().includes(e.toLowerCase())
                ? v.appendChild(n)
                : e || v.appendChild(n);
        }
    }
    function g(e) {
        ...
        t.classList.add("item-container"),
            ...
            (t.style.borderColor = m.borderColor || "#8fbd56"),
            (t.style.background = m.bgColor || "#8fbd56");
    ...
    (n = document.getElementById(e)),
        (function () {
            ...
            (i = document.createElement("div")).classList.add("body","form-control"),
            t.shadow && i.classList.add("shadow"),
            d.id="mult-select-tag",
            ...
            (c.placeholder = `${t.placeholder || "Buscar problema ..."}`),
            ...
            s.append(u);
            o.id = "id_input-container";
            u.id = "id_button";
        const e = h.parseFromString(
            '<svg xmlns="http://www.w3.org/2000/svg" width="150%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">\n            <polyline points="18 15 12 21 6 15"></polyline></svg>',
            "image/svg+xml"
        ).documentElement;
        ...
        u.append(e),
            ...
            // Se elimina la verificación de preferencia de tema almacenada en localStorage.
            // Se fuerza la asignación de la clase 'drawer', estandarizando la visualización del componente
            // en su estilo base y deshabilitando la alternancia automática al modo oscuro para este elemento.
            p.classList.add('drawer');
            p.classList.remove('drawer-dark');
